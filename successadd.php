...
<h1 style="text-align: center;padding-top:8%;color:aliceblue;font-family: 'Poppins', sans-serif;padding-bottom:1%;padding-left:5%;padding-right:5%;">Investment Details Inserted Successfully!!!</h1>
<a href="add.php" style=" padding-left: 35%;color: cadetblue; font-family: 'Poppins', sans-serif;font-size: 20px">Add more records</a>
<a href="display.php" style="padding-left:3%;color: cadetblue; font-family: 'Poppins', sans-serif;font-size: 20px">View investment records</a>
